    ...
    <div class="a11y-overlay" id="accessibilityModal" role="dialog" aria-modal="true" aria-labelledby="accessibilityTitle">
      <div class="a11y-card" id="accessibilityCard" tabindex="-1">
        ...
        <div class="a11y-controls">
          <button type="button" class="a11y-toggle" id="motionToggle" aria-pressed="false"><span><strong>Reduce motion</strong>Disable card flips, shakes, sparks, and most transitions.</span><span class="toggle-state" id="motionState">OFF</span></button>
...
function systemReduceMotion(){try{return window.matchMedia&&window.matchMedia('(prefers-reduced-motion: reduce)').matches}catch(e){return false}}
function loadAccessibilityPrefs(){const r=readPref('acidBattleReduceMotion'),m=readPref('acidBattleManualAdvance');reduceMotion=r===null?systemReduceMotion():r==='1';manualAdvance=m==='1';applyAccessibilityPrefs()}
